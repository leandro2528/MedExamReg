...
<div class="container">
    <div class="row my-3">
        <div class="">
            ...
            <a class="btn btn-primary btn-sm my-3" href="">
    ...
    <div class="row">
        <div class="col d-flex justify-content-between">
            ...
            <div class="card-box-info-pacient shadow p-4">
            
                <img style="width: 160px;" src="{{ $patient->foto }}" alt="">
                <h6 class="my-3 text-center">{{ $patient->nome }}</h6>
                <div class="btn-info-pacient text-center">
